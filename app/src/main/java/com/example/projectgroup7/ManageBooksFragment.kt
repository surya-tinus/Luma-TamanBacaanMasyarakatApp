...
import com.example.projectgroup7.model.BookItem
    ...
    private fun fetchBooks() {
        ...
        categories.forEach { category ->
            RetrofitClient.instance.searchBooks("subject:$category")
                .enqueue(object : Callback<com.example.projectgroup7.model.BookResponse> {
                    override fun onResponse(
                        call: Call<com.example.projectgroup7.model.BookResponse>,
                        response: Response<com.example.projectgroup7.model.BookResponse>
                    ) {
                    ...
                    override fun onFailure(call: Call<com.example.projectgroup7.model.BookResponse>, t: Throwable) {
                        t.printStackTrace()
